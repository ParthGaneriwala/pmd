...
@parser::members {
    ...
    static final AntlrNameDictionary DICO = new SoarNameDictionary(VOCABULARY, ruleNames);

    @Override
    protected SoarTerminalNode createPmdTerminal(ParserRuleContext parent, Token t) {
        return new SoarTerminalNode(t);
    }

    @Override
    protected SoarErrorNode createPmdError(ParserRuleContext parent, Token t) {
        return new SoarErrorNode(t);
    }
}
